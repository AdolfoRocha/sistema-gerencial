...
interface NewPayableFormProps {
  onClose: () => void;
  onSuccess: () => void;
}

const NewPayableForm: React.FC<NewPayableFormProps> = ({ onClose, onSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl w-full max-w-md p-6 relative">
        ...
        <h2 className="text-xl font-semibold mb-6">Nova Conta a Pagar</h2>
